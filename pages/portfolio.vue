<template>
  <div class="bg-gray-600 py-10">
    ...
    <div class="mt-20 ">
      <h1 class="text-4xl font-bold text-white flex justify-center mx-auto lg:text-6xl">Flyer design</h1>
      <VueSlickCarousel :autoplay="true" :cssEase="ease" :pauseOnHover="true" :variableWidth="true" :arrows="false" :dots="false" :adaptiveHeight="true" class="gap-4 mt-8 w-full ">

        <div class="bg-white relative" style="width: 400px;">
